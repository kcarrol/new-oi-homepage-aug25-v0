        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-300 max-w-4xl mx-auto">
              Extend the reach of your control and IT systems by turning siloed data into live, accessible insight.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Use Case 1 - Unified Batch Traceability */}
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Unified Batch Traceability</h3>
                </div>
                <p className="text-slate-300 leading-relaxed">
                  Instantly query across MES, LIMS, and historian data to correlate quality results with production
                  events — without manual exports or spreadsheets.
                </p>
              </CardContent>
            </Card>

            {/* Use Case 2 - Cross-Line & Shift Reporting */}
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Cross-Line & Shift Reporting</h3>
                </div>
                <p className="text-slate-300 leading-relaxed">
                  Automate OEE, yield, and downtime summaries from live telemetry and operational systems — governed and
                  ready for dashboards or APIs.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Regulatory Audit Readiness</h3>
                </div>
                <p className="text-slate-300 leading-relaxed">
                  Expose governed, schema-aware data sets for compliance checks — ensuring auditors see consistent,
                  validated telemetry across systems.
                </p>
              </CardContent>
            </Card>

            {/* Use Case 4 - Lab-Process Correlation */}
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Lab-Process Correlation</h3>
                </div>
                <p className="text-slate-300 leading-relaxed">
                  Connect lab results directly to production runs and equipment telemetry to accelerate root cause
                  analysis and shorten investigation cycles.
                </p>
              </CardContent>
            </Card>

            {/* Use Case 5 - Governed Data Sharing */}
            <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-white">Governed Data Sharing</h3>
                </div>
                <p className="text-slate-300 leading-relaxed">
                  Publish live queries as secure APIs so engineering, operations, and IT teams work from the same
                  trusted data — no data wrangling required.
                </p>
              </CardContent>
            </Card>

            {/* Ready to Start CTA Card */}
            <Card className="bg-gradient-to-br from-slate-700 to-slate-600 border-slate-600 hover:from-slate-600 hover:to-slate-500 transition-all duration-300">
              <CardContent className="p-8 text-center flex flex-col justify-center h-full">
                ...
                <p className="text-slate-300 mb-6 leading-relaxed">
                  Transform your industrial data into actionable insights today.
                </p>
